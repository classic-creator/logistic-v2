...
class TripCreatedEvent extends BaseDomainEvent
{
    ...
    {
        return "New Trip Created: {$this->tripNumber}";
    }

    public function getNotificationBody(): string
    {
        return "Trip {$this->tripNumber} has been successfully created and queued for dispatch.";
    }
